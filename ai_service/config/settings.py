"""
Django settings for AI Categorization Service.
"""
import os
import sys
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'ai-service-dev-secret-key')
...
# REDIS_URL uses database index /2 for AI service (matches docker-compose.yml).
CACHES = {
    "default": {
        ...
        "KEY_PREFIX": "ai",  # All keys look like: ai:categories:...
    }
}
