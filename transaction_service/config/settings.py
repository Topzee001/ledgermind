"""
Django settings for the Transaction Service.
"""
import os
import sys
...
# REST Framework - uses shared JWT authentication for inter-service auth
REST_FRAMEWORK = {
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'LedgerMind - Transaction Service API',
