...
# Logging – send errors to stdout so they appear in Render logs
LOGGING = {
    'version': 1,
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'LedgerMind - User Service API',
    'DESCRIPTION': 'User authentication and business profile management',
    'VERSION': '1.0.0',
}
